...
export default function PatientsPage() {
    ...
    return (
        <main className="min-h-screen p-3 md:p-6 space-y-6 max-w-[1440px] mx-auto animate-in fade-in duration-1000 bg-[#f6f7fb]">
            {/* Header */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 pb-6">
                <div className="space-y-1">
                    <Link href="/" className="inline-flex items-center gap-1.5 text-[10px] font-bold text-muted-foreground uppercase tracking-[0.3em] hover:text-slate-900 transition-colors mb-2">
                        <ArrowLeft className="w-2.5 h-2.5" /> Back to Console
                    </Link>
                    <h1 className="text-2xl font-bold tracking-tighter text-slate-900 font-outfit uppercase">
                        Archive <span className="text-slate-400">/</span> Patients
                    </h1>
                </div>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="pl-9 pr-4 py-2 bg-white/5 border border-slate-200 rounded text-[10px] font-mono focus:border-white/40 outline-none w-full md:w-[260px] text-slate-900 transition-colors uppercase"
                    />
                </div>
            </div>
